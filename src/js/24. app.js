var App = function () {
    ...
    var handleGoTop = function () {
        ...
        /*jQuery('#Payment_CARA_PEMBAYARAN_1').click(function () {
            App.scrollTo($('#Payment_TANGGAL_TRANSFER'));
        });

        jQuery('#Payment_JENIS_PEMBAYARAN').change(function () {
            App.scrollTo($('#scroll-pembayaran'));
        });*/
    }
    ...
    return {
        ...
        blockUI: function (el, loaderOnTop) {
            lastBlockedUI = el;
            jQuery(el).block({
                message: '<img src="../../../themes/metronic/assets/img/loading.gif" align="absmiddle">',
                css: {
                    border: 'none',
                    padding: '2px',
